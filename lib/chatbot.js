...
`;
const systemInstruction = `You are the official ServicePulseHub Assistant. STRICT LIMIT: Use ONLY the following information to answer:\n${knowledgeBase}\nIf a user asks about something else, politely tell them you can only assist with ServicePulseHub inquiries. Be helpful, professional, and concise.`;
const fallbackResponse =
  "I apologize for the temporary issue. Here's what I can help you with: We offer device repair services for smartphones, tablets, and laptops. Feel free to ask me about our services, location, hours, or contact information!";
...
const fallbackResponses = [
  ...
  },
  {
    ...
    response: "We are located at 123 Repair Street, Tech City, TC 12345.",
  },
  {
    prompt: "What are your hours?",
    response:
      "Our hours are Monday to Friday, 9 AM to 6 PM, and Saturday from 10 AM to 4 PM. We are closed on Sundays and public holidays.",
  },
  {
    prompt: "What is your contact information?",
    response:
      "You can contact us at (123) 456-7890 or email at info@servicepulsehub.com.",
  },
];

function getFallbackResponse(prompt) {
  const match = fallbackResponses.find((item) =>
    prompt.toLowerCase().includes(item.prompt.toLowerCase()),
  );
