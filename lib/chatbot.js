...
async function getChatbotResponse({ prompt }) {
  ...
  if (!process.env.NEXT_PUBLIC_GEMINI_API_KEY) {
    ...
    return "I apologize for the temporary issue. Here's what I can help you with: We offer device repair services for smartphones, tablets, and laptops. Feel free to ask me about our services, location, hours, or contact information!";
  }
